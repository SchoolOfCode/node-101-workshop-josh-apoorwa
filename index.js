...
function describeItem(item){
 ...
 if (item[i].count === 1){
     console.log(`I have a ${item[i].name}. Here's what I like about it: ${item[i].whatILike}`);
      }
      else {
          console.log(`I have ${item[i].count} ${item[i].name}. Here's what I like about them: ${item[i].whatILike}`);
      }
}
}
